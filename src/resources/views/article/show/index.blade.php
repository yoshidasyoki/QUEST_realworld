                ...
                @if ($isAuthor)
                    <div class="flex gap-5">
                        <a href={{ route('article.edit', $article->id) }}>
                            <button type="submit"
                                class="text-sm text-gray-400 p-1 border border-gray-400 rounded cursor-pointer">Edit Article
                            </button>
                        </a>
                        <form action={{ route('article.destroy', $article->id) }} method="POST">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="text-sm text-red-600 p-1 border border-red-600 rounded cursor-pointer">Delete Article
                            </button>
                        </form>
                    </div>
                @endif
